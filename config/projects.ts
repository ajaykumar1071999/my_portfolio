...
export const Projects: ProjectInterface[] = [
  {
    id: "Skill Assessment",
    companyName: "Radiant Infonet pvt. ltd.",
    type: "Personal",
    category: ["Web Dev", "Frontend", "UI/UX"],
    shortDescription:
      "Crafted a dynamic skill assessment platform for Radiant Infonet, enabling users to evaluate and enhance their skills through interactive quizzes and personalized feedback.",
    websiteLink: "",
    githubLink: "https://github.com/ajaykumar1071999",
    techStack: [
      "Next.js",
      "React",
      "Typescript",
    ...
    companyLogoImg:
      "https://app.testaonline.com/static/media/Testa%20blue1.2dd7bed8c3292294804e.webp",
    pagesInfoArr: [
      {
